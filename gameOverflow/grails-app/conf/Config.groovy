...
grails.plugin.springsecurity.userLookup.userDomainClassName = 'gameoverflow.User'
...
gameoverflow.question.index.max = 20
gameoverflow.question.vote.weight = 1

//users
gameoverflow.user.index.max = 10
